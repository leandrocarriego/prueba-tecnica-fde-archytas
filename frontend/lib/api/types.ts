...
export interface paths {
    ...
    "/api/v1/prices/summary": {
        ...
        /**
         * The four counts on top of the price list
         * @description The whole-catalog movement of the last sync: rose, fell, new without a
         *     rubro, and stopped coming. Every authenticated role.
         */
        get: operations["price_summary_api_v1_prices_summary_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/triage/cases": {
        ...
        /**
         * What the platform set aside
         * @description Anybody signed in, and each of them sees the areas they reach (RF-12).
         *
    ...
    "/api/v1/triage/cases/{case_id}/resolution": {
         ...
         * @description Anybody signed in, for a case of an area they reach — and no other.
         *
    ...
    "/api/v1/calendar/stream": {
        ...
        /**
         * The live channel of the calendar
         * @description All three roles, `READ`: sales watches the calendar live too (RF-37).
         *
         ...
         */
        get: operations["calendar_stream_api_v1_calendar_stream_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/messages/senders": {
        ...
        /**
         * The suppliers the inbox can be filtered by
         * @description The owner and purchasing (RF-26 of 007).
         *
         ...
         */
        get: operations["list_senders_api_v1_messages_senders_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        CaseList: {
             ...
             * @default []
             */
            sections: components["schemas"]["BusinessSection"][];
        };
        /**
         * CaseRead
        ...
        /**
         * PriceMovement
         * @description One of the two directions a price can move between the last two lists.
         */
        PriceMovement: {
            /** Count */
            count: number;
        ...
        /**
         * PriceSummary
         * @description The four counts on top of the prices screen, over the whole catalog.
         *
         ...
         */
        PriceSummary: {
            raised: components["schemas"]["PriceMovement"];
            lowered: components["schemas"]["PriceMovement"];
            /** Unclassified */
            unclassified: number;
            /** Discontinued */
            discontinued: number;
         ...
         * @enum {string}
         */
        Section: "PRICES" | "CALENDAR" | "SUPPLIERS" | "PURCHASE_INVOICES" | "PAYMENTS" | "PURCHASE_ORDERS" | "RECEIPTS" | "SUPPLIER_MESSAGES" | "SALES" | "DASHBOARD" | "STOCK" | "PRODUCT_CATEGORIES" | "PRODUCT_CATALOG" | "ACCESS_ADMIN" | "ACCESS_LOG" | "SYSTEM_PARAMETERS" | "MANUAL_CORRECTIONS";
        /**
         * StockCut
...
export interface operations {
    ...
    list_prices_api_v1_prices_get: {
        parameters: {
            query?: {
                ...
                highlighted?: boolean;
                /** @description Only rows whose price moved from the last one */
                changed?: boolean;
                /** @description Only products under this rubro */
                category_id?: number | null;
            };
            header?: never;
            path?: never;
    ...
    price_summary_api_v1_prices_summary_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    list_cases_api_v1_triage_cases_get: {
        parameters: {
            query?: {
                ...
                batch_id?: number | null;
                /** @description Only the cases of one area of the business */
                section?: components["schemas"]["BusinessSection"] | null;
            };
            header?: never;
            path?: never;
            cookie?: never;
    ...
    calendar_stream_api_v1_calendar_stream_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    list_senders_api_v1_messages_senders_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
